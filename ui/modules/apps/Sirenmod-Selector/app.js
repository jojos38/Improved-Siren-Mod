...
app.directive('sirenmodselector', ['UiUnits', function (UiUnits) {
	return {
		templateUrl: 'modules/apps/Sirenmod-Selector/app.html',
		replace: true,
		restrict: 'EA',
		scope: true
	}
...
app.controller("SirenmodSelector", ['$scope', 'bngApi', function ($scope, bngApi) {
